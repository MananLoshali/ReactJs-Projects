...
const Decs = styled.div`
    ...
    ${mobile({marginLeft: "0px",backgroundColor:"lightgrey",marginBottom:"5px"})}
...
const Title = styled.h1`
    ...
    ${mobile({fontSize: "15px",marginTop:"10px",textAlign:"center",marginBottom:"0px"})}
`
...
const Listitems = styled.li`
    ...
    ${mobile({lineHeight: "20px",lineHeight:"40px"})}
`
...
const Footer = () => {
  return (
    <Container>
      <Decs>
        <Logo>BAZZAR</Logo>
        <Para>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam hic ab a omnis impedit molestias, enim aperiam ipsa alias eum ipsam obcaecati officiis consectetur incidunt eligendi voluptatem nulla? Beatae, voluptates.</Para>
        <Icons>
            <Facebook/>
            <Instagram/>
            <Twitter/>
